...
export default function Banks (props){
    ...
    const colums = ["Kode Bank", "Nama Bank", "Nomor Rekening", "Nama Rekening", "Status", "Action"];
    const options = {
      search: false,
      filterType: "dropdown",
      print: false,
          ...
          <MUIDataTable
            ...
            data={data.map((item,index) => {
              return [
                  ...
                  <>
                    <Link to={"/edit-rekening/"+item.id}><Button size="sm" color="primary" style={{marginRight: 5}}>Edit</Button></Link>
