...
export default class ManualTransaction extends Component {
  constructor(props) {
    super(props)
        ...
        <Row>
          <Col xs="9">
            <Fade timeout={this.state.timeout} in={this.state.fadeIn}>
              <Card>
                <CardHeader>
                  <i className="fa fa-edit"></i>Input Transaction
                </CardHeader>
                  ...
                  <CardBody>
                    <Form className="form-horizontal">
                      ...
                      <FormGroup>
                        ...
                        <div className="controls">
                          <InputGroup className="input-prepend">
                            <Input id="appendedPrependedInput" size="16" type="number" required />
                          </InputGroup>
                        </div>
                      </FormGroup>
                      <FormGroup>
                        <Label htmlFor="appendedPrependedInput">Nominal</Label>
                        <div className="controls">
                          <InputGroup className="input-prepend">
                            <Input id="appendedPrependedInput" size="16" type="number" required/>
                          </InputGroup>
